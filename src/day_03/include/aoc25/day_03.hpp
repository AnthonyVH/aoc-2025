 ...
 * the bank produces is equal to the number formed by the digits on the batteries you've turned on.
 * For example, if you have a bank like 12345 and you turn on batteries 2 and 4, the bank would
 ...
 * - In 818181911112111, the joltage 888911112111 is produced by turning on everything except some
 *   1s near the front.
 *
