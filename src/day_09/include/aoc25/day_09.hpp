 ...
 * theater!
 *
 * The movie theater has a big tile floor with an interesting pattern. Elves here are redecorating
 * the theater by switching out some of the square tiles in the big grid they form. Some of the
 * tiles are red; the Elves would like to find the largest rectangle that uses red tiles for two of
 * its opposite corners. They even have a list of where the red tiles are located in the grid (your
 * puzzle input).
 *
 * For example:
 *
 ...
 * ..............
 *
 * You can choose any two red tiles as the opposite corners of your rectangle; your goal is to find
 * the largest rectangle possible.
 *
 ...
 *
 * In your list, every red tile is connected to the red tile before and after it by a straight line
 * of green tiles. The list wraps, so the first red tile is also connected to the last red tile.
